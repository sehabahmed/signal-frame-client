...
const MorphyButtonLeft = React.forwardRef<HTMLButtonElement, MorphyButtonProps>(
  (
    {
      className,
      size,
...
MorphyButtonLeft.displayName = "MorphyButton";

export { MorphyButtonLeft, morphyButtonVariants };
